...
import com.viclee.verticalswitchtextview.view.ScrollTextView;
...
public class DemoActivity extends Activity {
    ...
    List<ScrollTextView.OnScrollClickListener> listener1 = new ArrayList<ScrollTextView.OnScrollClickListener>();

    List<ScrollTextView.OnScrollClickListener> listener2 = new ArrayList<ScrollTextView.OnScrollClickListener>();
    ...
    private void initData()
    {
        ...
        listener1.add(new ScrollTextView.OnScrollClickListener()
        {
        ...
        listener2.add(new ScrollTextView.OnScrollClickListener()
        {
